<template>
  <div class="footer-content">
    <div class="footer">
      <div class="links">
        <a href="https://cnodejs.org/rss" class="dark">RSS</a>|
        <a href="https://github.com/cnodejs/nodeclub/" class="dark">源码地址</a>
      </div>
      <p>
      ...
      <p>
        ...
        <a href="">
          <img
            src="//static2.cnodejs.org/public/images/digitalocean.png"
            alt=""
          />
        </a>
        ，存储赞助商为
